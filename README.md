...
Styled with a French flag color palette (blue/white/red) and a fixed left sidebar for page navigation and sector/company filtering. The Power BI dashboard has 3 pages:
